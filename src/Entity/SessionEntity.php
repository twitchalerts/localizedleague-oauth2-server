...
namespace LocalizedLeague\OAuth2\Server\Entity;

use LocalizedLeague\OAuth2\Server\AbstractServer;
use LocalizedLeague\OAuth2\Server\Event\SessionOwnerEvent;
