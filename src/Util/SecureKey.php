...
namespace LocalizedLeague\OAuth2\Server\Util;

use LocalizedLeague\OAuth2\Server\Util\KeyAlgorithm\DefaultAlgorithm;
use LocalizedLeague\OAuth2\Server\Util\KeyAlgorithm\KeyAlgorithmInterface;
